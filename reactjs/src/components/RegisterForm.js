      ...
      return (
        <>
          ...
          <input
            ...
            className="input-register"
          />
          <label htmlFor="seller_name" className="label-register">
            Seller name:
          </label>
          <input
            id="seller_name"
  ...
  async function registerCustomer() {
    ...
    if (validateCustomer(username, password, confirm, name, surname, address)) {
      ...
      try {
        ...
        alert(
          "successfully registered! log in before u start using the website"
        );
        ...
        if (error.response.status === 409) {
          ...
          setError(
            "Data you entered is invalid! Make sure you have unique username"
          );
        }
        setShowAlert({
          success: false,
    ...
    if (
      ...
      try {
        ...
        if (error.response.status === 409) {
          ...
          setError(
            "Data you entered is invalid! Make sure you have unique email & username"
          );
        }
    ...
    <>
      <div className="registerInfoCard">
        ...
        <div className="radios">
          ...
          />
          <label className="labelRadio left" htmlFor="male">
            Register as customer
          </label>
