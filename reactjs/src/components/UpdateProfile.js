...
const UpdateProfile = () => {
    ...
    sellerData = (
      <>
        ...
        <input
          ...
          className="input-register"
          onChange={handleFormInputChange("sellerName")}
        />
        ...
        <input
          ...
          value={formated}
          className="input-register"
          onChange={handleFormInputChange("since")}
        />
      </>
    );
  }
      ...
      >
        <div className="register-form">
          ...
          <input
            ...
            className="input-register"
            onChange={handleFormInputChange("surname")}
          />
          <label htmlFor="address" className="label-register">
            Address:
          </label>
  ...
  return (
    <>
      ...
      <div className="updateInfoCard">{sameData}</div>
    </>
  );
};
